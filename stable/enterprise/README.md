...
| Name                                    | Description                                                                                                                                                                                                                                                  | Value                                       |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
| `image`                                 | Image used for all Anchore Enterprise deployments, excluding Anchore UI                                                                                                                                                                                      | `docker.io/anchore/enterprise@sha256:<TBD>` |
...
### v3.23.x
  ...
  #### V3.23.1
    - Deploys Anchore Enterprise v5.26.1. See the [Release Notes](https://docs.anchore.com/current/docs/releasenotes/5261/) for more information.
### v3.22.x
  #### V3.22.0
