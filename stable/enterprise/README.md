...
| Name                                    | Description                                                                                                                                  | Value                                                                                                  |
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `image`                                 | Image used for all Anchore Enterprise deployments, excluding Anchore UI                                                                      | `docker.io/anchore/enterprise@sha256:66b214f11280f1329e4ad028a0f2d045c894846ff79da0070e1b7fb13d2b148d` |
...
| `anchoreConfig.extendedConfig`                                                          | appends additional configs to the root config. This should only be used with guidance from Anchore CS.                           | `{}`                        |
...
| `anchoreConfig.component_catalog.logging`                                               | Logging configuration for the component catalog                                                                                  | `{}`                        |
...
| Name                           | Description                                                                                                                                                                  | Value                                                                                                     |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `ui.image`                     | Image used for the Anchore UI container                                                                                                                                      | `docker.io/anchore/enterprise-ui@sha256:bcfd94db6b810b762274c74b52bba27a886f3a53f57bb70874a5c142a6709f97` |
