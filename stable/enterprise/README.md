...
| `anchoreConfig.catalog.runtime_inventory.inventory_ttl_days`               | TTL for images in the inventory report working set                                                                               | `120`              |
| `anchoreConfig.catalog.runtime_inventory.inventory_ingest_overwrite`       | disables the inventory_ttl cycle timer.                                                                                          | `false`            |
