...
| `anchoreConfig.reports_worker.ingress_images_max_workers`                               | The maximum number of concurrent threads to ingress images                                                                       | `50`                        |
...
| `analyzer.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`   |
...
| Name                            | Description                                                                                                                                                                  | Value       |
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `api.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `catalog.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `dataSyncer.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `notifications.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `policyEngine.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `reports.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `reportsWorker.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
...
| `simpleQueue.configOverride`            | Allows for overriding the default Anchore configuration file                                                                                                                 | `""`        |
