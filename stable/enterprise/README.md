...
helm install --namespace=my-namespace --set image=docker.io/anchore/anchore-engine:v${ANCHORE_VERSION} --set image=docker.io/anchore/enterprise:v${ANCHORE_VERSION} -f anchore_values.yaml my-anchore anchore/anchore-engine
```
